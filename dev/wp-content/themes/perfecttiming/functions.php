...
/************** START CODE FOR ADD IMAGE SIZE ******************/ 

add_image_size('slider_image_size',1920,494);
add_image_size('our_team_image_size',257,308);
add_image_size('our_client_logo_size',418,168);
add_image_size('work_talent_banner_size',1920,423);
add_image_size('contact_banner_image_size',1920,600);
add_image_size('category_banner_image_size',1920,375);

/************** END CODE FOR ADD IMAGE SIZE ******************/ 


/************** START CODE FOR CREATE CUSTOM POST SLIDER ******************/ 

function codex_slider() {
  $labels = array(
    'name' => 'Slider',
...
add_action( 'init', 'codex_slider' ); 

/************** END OF CODE FOR CREATE CUSTOM POST SLIDER ******************/ 	


/************** START CODE FOR CREATE CUSTOM POST ASSIGNMENT INFORMATION  ******************/ 

function codex_assignment() {
  $labels = array(
    'name' => 'Assignment',
    ...
    'all_items' => 'All Assignment',
    'view_item' => 'View Assignment',
    'search_items' => 'Search Assignment',
    'not_found' =>  'No Assignment found',
    'not_found_in_trash' => 'No Assignment found in Trash', 
    'parent_item_colon' => '',
...
add_action( 'init', 'codex_assignment' ); 

/************** END OF CODE FOR CREATE CUSTOM POST ASSIGNMENT INFORMATION ******************/ 



/************** START CODE FOR CREATE CUSTOM POST OUR TEAM ******************/ 
...
add_action( 'init', 'codex_team' ); 

/************** END OF CODE FOR CREATE CUSTOM POST OUR TEAM ******************/ 



/************** START CODE FOR CREATE CUSTOM POST FAQS ******************/ 
...
add_action( 'init', 'codex_faqs' ); 

/************** END OF CODE FOR CREATE CUSTOM POST FAQS ******************/ 



/************** START CODE FOR CREATE CUSTOM POST OUR CLIENTS ******************/ 

function codex_clients() {
  $labels = array(
    'name' => 'Clients',
...
add_action( 'init', 'codex_clients' ); 

/************** END OF CODE FOR CREATE CUSTOM POST OUR CLIENTS ******************/ 




/****************************START CREATING CUSTOM POST EXPERTISE WITH CATEGORY ********************************/

function my_custom_post_Expertise() {
$labels = array(
  'name' => 'expertise',
  'singular_name' => 'expertise',
  'add_new' => 'Add expertise job',
  'add_new_item' => 'Add New expertise job',
  'edit_item' => 'Edit expertise',
  'new_item' => 'New expertise',
  'all_items' => 'All expertises jobs',
  'view_item' => 'View expertise',
  'search_items' => 'Search expertise',
  'not_found' =>  'No expertise found',
  'not_found_in_trash' => 'No expertise found in Trash', 
  'parent_item_colon' => '',
  'menu_name' => 'Expertise Jobs'
);
...
add_action( 'init', 'my_custom_post_Expertise' );

function my_taxonomies_expertise() {
 $labels = array(
   'name' =>  'expertise Categories',
'add_new_item' => 'Add New expertise category',
'search_items' => 'Search expertise Categories',
'edit_item' => 'Edit expertise Category',
   'menu_name' =>  'expertise Categories'
 );
 $args = array(
   'labels' => $labels,
   'hierarchical' => true,
 ...
 register_taxonomy( 'expertise_category', 'expertise', $args );
}
add_action( 'init', 'my_taxonomies_expertise');

/****************************END OF CREATING CUSTOM POST EXPERTISE WITH CATEGORY ********************************/
