				...
				<td>
					<table cellspacing="0" border="0" align="center" cellpadding="20" width="100%">
						...
						<tr align="center" >
							...
							<img src="http://i.imgur.com/bF97OUm.png" alt="G.T.G - Aluminium and Glass"></img>
							</strong></td>
						</tr><!-- -->
					</table>
						...
						<tr>
							<td>
								<table cellspacing="0" border="0" cellpadding="0" width="100%">
									...
									<tr>
										<td  align="right" style="width:20%; font-family:'PT Sans',sans-serif; font-size:13px; border:1px solid #efefef; border-top:0px; padding:8px;"><strong>Mesaage :</strong></td>
										<td  style="width:20%; font-family:'PT Sans',sans-serif; font-size:13px; border-right:1px solid #efefef; border-bottom:1px solid #efefef; padding:8px;">[[message]]</td>
									</tr>
								</table>
							</td>
							<td width="30"></td> 
					...
					<table cellspacing="0" border="0" align="center" cellpadding="0" width="100%" style="border:0px solid #efefef; margin-top:20px; padding:0px;">
						<tr>
							...
							<b>G.T.G - Aluminium and Glass</b></strong></td> 
						</tr>
					</table>
				</td>   
			</tr>
