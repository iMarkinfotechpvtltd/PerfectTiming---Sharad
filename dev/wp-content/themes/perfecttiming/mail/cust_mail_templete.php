			...
			<tr>
				<td>
					...
					<table cellspacing="0" border="0" align="center" cellpadding="10" width="100%" style="border:0px solid #efefef; margin-top:0px; padding:40px;">
						...
						<tr>
						<td><p><h4>Thank you for reaching out to us. We will get back to you shortly..<h4></p></td>
						</tr>
						<tr>
							<td>
								<table cellspacing="0" border="0" cellpadding="0" width="100%">	
									<tr>
										<td><h3>Best Regard's</h3>
											<h3>G.T.G - Aluminium and Glass</h3>
											<h3>Website : <a href="[[siteurl]]">[[siteurl]]</a></h3>
										</td>
									</tr>
								</table>
							</td>
